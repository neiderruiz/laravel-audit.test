...
<div class="flex justify-end py-2">
    ...
    <div class="flex">
        ...
        <form class="max-w-sm w-2/3 mx-auto space-y-2" action="{{ route('articles.update',[$article->id]) }}" method="POST"
            ...
            <div class="mb-5">
                ...
                <input value="{{ old('title') ?? $article->title }}" type="text" id="name" name="title"
